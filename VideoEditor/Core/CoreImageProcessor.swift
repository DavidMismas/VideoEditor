...
class CoreImageProcessor {
    ...
    func applyAdjustments(_ adjustments: ColorAdjustments, to image: CIImage) -> CIImage {
        ...
        // 3. Color Controls (Contrast, Saturation, Global Luminance)
        if adjustments.contrast != 1.0 || adjustments.saturation != 1.0 || adjustments.luminance != 0 {
            ...
            colorControlsFilter?.setValue(adjustments.luminance, forKey: kCIInputBrightnessKey)
        ...
        // 5. True HSL + Color Grading (3D LUT)
